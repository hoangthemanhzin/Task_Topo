...
const (
	SERVICE_PATH = "uepc/npcf-ue-policy-control/v1"
)
...
*/
func ReadIndividualUEPolicyAssociation(client sbi.ConsumerClient, polAssoId string) (rsp *models.PolicyAssociation, err error) {
...
*/
func ReportObservedEventTriggersForIndividualUEPolicyAssociation(client sbi.ConsumerClient, polAssoId string, body models.PolicyAssociationUpdateRequest) (rsp *models.PolicyUpdate, err error) {
...
@return *models.PolicyAssociation,
*/
func CreateIndividualUEPolicyAssociation(client sbi.ConsumerClient, body models.PolicyAssociationRequest) (rsp *models.PolicyAssociation, err error) {
